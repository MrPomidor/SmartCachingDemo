...
{
    public class RedisLRUStatsCollector : StatsCollectorBase<LRUCacheCountersStats>
    {
        public RedisLRUStatsCollector(int processId) : base(processId)
        {
        }

        private static readonly string ProviderName = CountersConsts.EventSources.RedisLRUProductsCache;
