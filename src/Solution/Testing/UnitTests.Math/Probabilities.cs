...
namespace UnitTests.Math
{
    public class Probabilities
    {
        ...
        public void CacheItemTouchedProbability(int numberOfEvents, int expectedOccurencies, double probabilityOfItem)
        {
            // 1. Cnk
            // 2. pK
            // 3. qN-K
        ...
        [InlineData(10_000, 0.0002)] // 1 - 3 (uniform distribution)
        [InlineData(10_000, 0.0008)] // 7 - 9 (Pareto distribution)
        public void CalculateMostProbableValue(int totalItems, double successProbability)
        {
